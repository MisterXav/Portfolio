...
<template>
    ...
    <ol class="relative border-s border-gray-200 dark:border-gray-700">
        ...
        <li class="mb-10 ms-6">
            ...
            <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">BAC STI2D Mention Assez Bien</h3>
            <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-400">Juillet 2022</time>
            <p class="text-base font-normal text-gray-500 dark:text-gray-300">
                J'ai obtenu mon bac STI2D en Juillet 2022 option SIN mention Assez Bien.<br>
                Durant le Bac STI2D j'ai appris le HTML, le CSS, le PHP ainsi que l'arduino sur divers projets.
            </p>
        </li>
    </ol>

    <!-- EXPéRIENCES -->
    <h2 class="mt-40 mb-4 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">Expériences</h2>
    ...
    <div class="py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 class="mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">Langages et outils maitrisés : </h2>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-4 sm:gap-4">
        ...
        <div class="transition-all duration-300 ease-in-out hover:scale-110 hover:ring-2 hover:ring-orange-500 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <svg class="block m-auto" width="64px" height="64px" viewBox="0 0 32.00 32.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.00032"><g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(0,0), scale(1)"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.8960000000000001"></g><g id="SVGRepo_iconCarrier"> <path d="M6 28L4 3H28L26 28L16 31L6 28Z" fill="#E44D26"></path> <path d="M26 5H16V29.5L24 27L26 5Z" fill="#F16529"></path> <path d="M9.5 17.5L8.5 8H24L23.5 11H11.5L12 14.5H23L22 24L16 26L10 24L9.5 19H12.5L13 21.5L16 22.5L19 21.5L19.5 17.5H9.5Z" fill="white"></path> </g></svg>            <div class="p-5">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">HTML</h5>
            </div>
        </div>

        <!-- CSS -->
        <div class="transition-all duration-300 ease-in-out hover:scale-110 hover:ring-2 hover:ring-blue-600 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <svg class="block m-auto" width="64px" height="64px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 28L4 3H28L26 28L16 31L6 28Z" fill="#1172B8"></path> <path d="M26 5H16V29.5L24 27L26 5Z" fill="#33AADD"></path> <path d="M19.5 17.5H9.5L9 14L17 11.5H9L8.5 8.5H24L23.5 12L17 14.5H23L22 24L16 26L10 24L9.5 19H12.5L13 21.5L16 22.5L19 21.5L19.5 17.5Z" fill="white"></path> </g></svg>            <div class="p-5">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">CSS</h5>
            </div>
        </div>

        <!-- JS -->
        <div class="transition-all duration-300 ease-in-out hover:scale-110 hover:ring-2 hover:ring-yellow-400 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <router-link :to="{ name: 'Projets'}">
        <button type="button" class="mt-10 text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 text-center inline-flex items-center">
            Voir mes projets
